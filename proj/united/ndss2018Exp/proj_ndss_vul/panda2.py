...
# Global setting
OUT_DIR = "./myavatar"
PANDA_PATH = "/doit/firmware/ndss_exp/try_ndss18_exp/panda_modifications/build/arm-softmmu/qemu-system-arm"
PROJ_PATH = "/doit/firmware/test/proj_ndss_vul"

# proj specific settings
sample = PROJ_PATH + '/expat_panda.bin'
...
def start_panda_angr(avatar):
    ...
    IgnorePeripheralList = {
            "PeripheralRange1": (0x40000000, 0x4400),
    ...
    funcs = get_symbols(PROJ_PATH + '/expat_panda.elf')
