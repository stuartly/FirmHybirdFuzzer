...
RAM_FILE2 = {'start': 0x20000000, 'size': 0x28000,
             'file': "/dev/shm/SHM.2." + format(0x28000, '#04x')
             }

RAM_FILE3 = {'start': 0x40100000, 'size': 0x2000,
             'file': "/dev/shm/SHM.3." + format(0x2000, '#04x')
             }
...
sample = 'lpc54018iotmodule_lwip_httpsrv_bm.axf.raw'
...
if __name__ == "__main__":
    ...
    rom  = avatar.add_memory_range(ROM_START, ROM_FILE['size'], name='rom',
                                   file=sample,
