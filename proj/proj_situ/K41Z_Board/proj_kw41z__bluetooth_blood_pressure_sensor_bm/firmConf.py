...
# Firmware Dir
PROJ_PATH = "/home/stly/Documents/IoTFuzzing/CORTEX-M4-QEMU/proj/pro_situ_bugs/K41Z_Board/proj_kw41z__bluetooth_blood_pressure_sensor_bm"

FIRMWARE_NAME = "update.bfu"
#FIRMWARE_NAME = "frdmk66f_ftm_timer"
#FIRMWARE_NAME = "frdmk66f_freertos_uart"
# FIRMWARE_NAME = "frdmk66f_freertos_uart"
# FIRMWARE_NAME = "frdmk66f_adc16_polling"
#FIRMWARE_NAME = "frdmkw41z_wireless_examples_bluetooth_blood_pressure_sensor_bm"
# FIRMWARE_NAME = "frdmk66f_wdog"
...
UNKNOWN_PERIPHERAL_MEM_SIZE  = 0x5000000
...
EN_END_PC   = False
END_PC      = 0x780              # stop execution at END_PC

# Execution Control
EN_MULTIPLE_RUN_TIME = True     # set this False to run only once
RUN_TIME             = 1500    # Total time of multiple run (time/sec)
EN_ONE_RUN_TIME      = True     # set time limit for single run
ONE_RUN_TIME         = 100  # Total time of single run  (time/sec)

# Coverage Feedback Setting
EN_BB2BB = True                  # Enable counting the ratio of unique BB2BB coverage
BB2BB    = 10000                 # Setting the total unique BB2BB number which is obtained by static analysis in advance
...
#PLUGIN = "tcg-plugin-inst_tracking.so"
#PLUGIN = "tcg-plugin-div_tracking.so"
