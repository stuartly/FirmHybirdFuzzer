...
__assertion_failed = 0x1c3d
ASSERT_FUNC = {__assertion_failed}

# funcs = utils.get_symbols('./frdmk66f_crc.axf')
# __assertion_failed = format(funcs["__assertion_failed"] + 1, "#04x")
# ASSERT_FUNC = {__assertion_failed}
...
if __name__ == "__main__":
    ...
    IgnorePeripheralList = {
            "all-device": (0x40000000, 0x1fff0000),
            }
