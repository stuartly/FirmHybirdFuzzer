...
# Firmware Dir
PROJ_PATH     = "/home/stly/Documents/IoTFuzzing/CORTEX-M4-QEMU/proj/Demo/frdmk66f_lwip_ping_freertos"
FIRMWARE_NAME = "frdmk66f_lwip_ping_freertos"
...
# Fuzzing Boundary
EN_START_PC = False
START_PC    = 0xCC78              # save snaphost at START_PC when first reach here, and start execution from here in later run
EN_END_PC   = False
END_PC      = 0xCDEA              # stop execution at END_PC
...
ONE_RUN_TIME         = 180      # Total time of single run  (time/sec)
