...
# Firmware Dir
PROJ_PATH     = "/home/stly/Documents/IoTFuzzing/CORTEX-M4-QEMU/proj/Demo/frdmkw41z_wireless_examples_bluetooth_wireless_power_ptu_bm"
FIRMWARE_NAME = "frdmkw41z_wireless_examples_bluetooth_wireless_power_ptu_bm"
...
# Fuzzing Boundary
EN_START_PC = False
START_PC    = 0x254B8              # save snaphost at START_PC when first reach here, and start execution from here in later run
EN_END_PC   = False
END_PC      = 0x256F6              # stop execution at END_PC

# Execution Control
EN_MULTIPLE_RUN_TIME = False     # set this False to run only once
RUN_TIME             = 10800      # Total time of multiple run (time/sec)
EN_ONE_RUN_TIME      = True      # set time limit for single run
ONE_RUN_TIME         = 60      # Total time of single run  (time/sec)
