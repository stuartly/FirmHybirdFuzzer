...
# Firmware Dir
PROJ_PATH     = "/home/stly/Documents/IoTFuzzing/CORTEX-M4-QEMU/proj/proj_zc/proj_STM32L475VG_BLE_HeartRate"
FIRMWARE_NAME = ""

SAMPLE      = PROJ_PATH + '/STM32L475VG_BLE_HeartRate.bin'
...
# Fuzzing Boundary
EN_START_PC = True
START_PC    = 0x8001f2e              # save snaphost at START_PC when first reach here, and start execution from here in later run
EN_END_PC   = True
END_PC      = 0x8001fca              # stop execution at END_PC
