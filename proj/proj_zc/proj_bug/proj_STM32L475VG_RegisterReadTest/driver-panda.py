...
PROJ_PATH = "/home/stly/Documents/IoTFuzzing/CORTEX-M4-QEMU/proj/proj_zc/proj_bug/proj_STM32L475VG_RegisterReadTest"
ROM_START = 0x8000000
ROM_SIZE = 0x100000
...
>>>>>>> Stashed changes
    ...
    # get funcs.json
    funcs = get_symbols('./Test.out')
    f = open("funcs2.json", "a")
    f.write(str(funcs))
    f.close()
    plugins += ['hooknetwork=true']
    plugins += ['net_fun=%d' % funcs['HJXfunc']]
