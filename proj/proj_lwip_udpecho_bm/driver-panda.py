...
sample = './frdmk66f_lwip_udpecho_bm.axf.raw'
OUT_DIR = "./myavatar"
...
memcpy_addr = 0x00017cab
memset_addr = 0x00017cc1
stopHooks = {memcpy_addr, memset_addr, 0x6ea1} #memp_init_pool
