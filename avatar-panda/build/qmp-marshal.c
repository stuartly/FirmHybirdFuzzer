...
void qmp_marshal_begin_record(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v;
    q_obj_begin_record_arg arg = {0};
    ...
    visit_type_q_obj_begin_record_arg_members(v, &arg, &err);
    if (!err) {
        visit_check_struct(v, &err);
    }
    visit_end_struct(v, NULL);
    ...
    qmp_begin_record(arg.file_name, &err);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_begin_record_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}

void qmp_marshal_begin_record_from(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v;
    q_obj_begin_record_from_arg arg = {0};
    ...
    visit_type_q_obj_begin_record_from_arg_members(v, &arg, &err);
    if (!err) {
        visit_check_struct(v, &err);
    }
    visit_end_struct(v, NULL);
    ...
    qmp_begin_record_from(arg.snapshot, arg.file_name, &err);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_begin_record_from_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}

void qmp_marshal_begin_replay(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v;
    q_obj_begin_replay_arg arg = {0};
    ...
    visit_type_q_obj_begin_replay_arg_members(v, &arg, &err);
    if (!err) {
        visit_check_struct(v, &err);
    }
    visit_end_struct(v, NULL);
    ...
    qmp_begin_replay(arg.file_name, &err);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_begin_replay_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}
...
void qmp_marshal_block_commit(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_block_commit(arg.has_job_id, arg.job_id, arg.device, arg.has_base, arg.base, arg.has_top, arg.top, arg.has_backing_file, arg.backing_file, arg.has_speed, arg.speed, &err);
...
void qmp_marshal_blockdev_mirror(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_blockdev_mirror(arg.has_job_id, arg.job_id, arg.device, arg.target, arg.has_replaces, arg.replaces, arg.sync, arg.has_speed, arg.speed, arg.has_granularity, arg.granularity, arg.has_buf_size, arg.buf_size, arg.has_on_source_error, arg.on_source_error, arg.has_on_target_error, arg.on_target_error, &err);
...
void qmp_marshal_end_record(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v = NULL;
...
void qmp_marshal_end_replay(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v = NULL;
...
static void qmp_marshal_output_PandaPluginInfoList(PandaPluginInfoList *ret_in, QObject **ret_out, Error **errp)
{
    Error *err = NULL;
    Visitor *v;

    v = qobject_output_visitor_new(ret_out);
    visit_type_PandaPluginInfoList(v, "unused", &ret_in, &err);
    if (!err) {
        visit_complete(v, ret_out);
    }
    error_propagate(errp, err);
    visit_free(v);
    v = qapi_dealloc_visitor_new();
    visit_type_PandaPluginInfoList(v, "unused", &ret_in, NULL);
    visit_free(v);
}

void qmp_marshal_list_plugins(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    PandaPluginInfoList *retval;
    Visitor *v = NULL;
    ...
    retval = qmp_list_plugins(&err);
    if (err) {
        goto out;
    }

    qmp_marshal_output_PandaPluginInfoList(retval, ret, &err);
...
void qmp_marshal_load_plugin(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v;
    q_obj_load_plugin_arg arg = {0};
    ...
    visit_type_q_obj_load_plugin_arg_members(v, &arg, &err);
    if (!err) {
        visit_check_struct(v, &err);
    }
    visit_end_struct(v, NULL);
    ...
    qmp_load_plugin(arg.has_file_name, arg.file_name, arg.plugin_name, arg.has_plugin_args, arg.plugin_args, &err);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_load_plugin_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}
...
void qmp_marshal_plugin_cmd(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v;
    q_obj_plugin_cmd_arg arg = {0};
    ...
    visit_type_q_obj_plugin_cmd_arg_members(v, &arg, &err);
    if (!err) {
        visit_check_struct(v, &err);
    }
    visit_end_struct(v, NULL);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_plugin_cmd_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}
...
void qmp_marshal_unload_plugin(QDict *args, QObject **ret, Error **errp)
{
    Error *err = NULL;
    Visitor *v;
    q_obj_unload_plugin_arg arg = {0};
    ...
    visit_type_q_obj_unload_plugin_arg_members(v, &arg, &err);
    if (!err) {
        visit_check_struct(v, &err);
    }
    visit_end_struct(v, NULL);
    ...
    qmp_unload_plugin(arg.index, &err);
...
out:
    ...
    v = qapi_dealloc_visitor_new();
    visit_start_struct(v, NULL, NULL, 0, NULL);
    visit_type_q_obj_unload_plugin_arg_members(v, &arg, NULL);
    visit_end_struct(v, NULL);
    visit_free(v);
}
...
void qmp_marshal_x_blockdev_del(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_x_blockdev_del(arg.node_name, &err);
...
{
    qmp_register_command("add-fd", qmp_marshal_add_fd, QCO_NO_OPTIONS);
    qmp_register_command("add_client", qmp_marshal_add_client, QCO_NO_OPTIONS);
    qmp_register_command("balloon", qmp_marshal_balloon, QCO_NO_OPTIONS);
    qmp_register_command("begin_record", qmp_marshal_begin_record, QCO_NO_OPTIONS);
    qmp_register_command("begin_record_from", qmp_marshal_begin_record_from, QCO_NO_OPTIONS);
    qmp_register_command("begin_replay", qmp_marshal_begin_replay, QCO_NO_OPTIONS);
    qmp_register_command("block-commit", qmp_marshal_block_commit, QCO_NO_OPTIONS);
    qmp_register_command("block-dirty-bitmap-add", qmp_marshal_block_dirty_bitmap_add, QCO_NO_OPTIONS);
    qmp_register_command("block-dirty-bitmap-clear", qmp_marshal_block_dirty_bitmap_clear, QCO_NO_OPTIONS);
    qmp_register_command("block-dirty-bitmap-remove", qmp_marshal_block_dirty_bitmap_remove, QCO_NO_OPTIONS);
    qmp_register_command("block-job-cancel", qmp_marshal_block_job_cancel, QCO_NO_OPTIONS);
    qmp_register_command("block-job-complete", qmp_marshal_block_job_complete, QCO_NO_OPTIONS);
    qmp_register_command("block-job-pause", qmp_marshal_block_job_pause, QCO_NO_OPTIONS);
    qmp_register_command("block-job-resume", qmp_marshal_block_job_resume, QCO_NO_OPTIONS);
    qmp_register_command("block-job-set-speed", qmp_marshal_block_job_set_speed, QCO_NO_OPTIONS);
    qmp_register_command("block-set-write-threshold", qmp_marshal_block_set_write_threshold, QCO_NO_OPTIONS);
    qmp_register_command("block-stream", qmp_marshal_block_stream, QCO_NO_OPTIONS);
    qmp_register_command("block_passwd", qmp_marshal_block_passwd, QCO_NO_OPTIONS);
    qmp_register_command("block_resize", qmp_marshal_block_resize, QCO_NO_OPTIONS);
    qmp_register_command("block_set_io_throttle", qmp_marshal_block_set_io_throttle, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-add", qmp_marshal_blockdev_add, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-backup", qmp_marshal_blockdev_backup, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-change-medium", qmp_marshal_blockdev_change_medium, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-close-tray", qmp_marshal_blockdev_close_tray, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-mirror", qmp_marshal_blockdev_mirror, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-open-tray", qmp_marshal_blockdev_open_tray, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-snapshot", qmp_marshal_blockdev_snapshot, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-snapshot-delete-internal-sync", qmp_marshal_blockdev_snapshot_delete_internal_sync, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-snapshot-internal-sync", qmp_marshal_blockdev_snapshot_internal_sync, QCO_NO_OPTIONS);
    qmp_register_command("blockdev-snapshot-sync", qmp_marshal_blockdev_snapshot_sync, QCO_NO_OPTIONS);
    qmp_register_command("change", qmp_marshal_change, QCO_NO_OPTIONS);
    qmp_register_command("change-backing-file", qmp_marshal_change_backing_file, QCO_NO_OPTIONS);
    qmp_register_command("change-vnc-password", qmp_marshal_change_vnc_password, QCO_NO_OPTIONS);
    qmp_register_command("chardev-add", qmp_marshal_chardev_add, QCO_NO_OPTIONS);
    qmp_register_command("chardev-remove", qmp_marshal_chardev_remove, QCO_NO_OPTIONS);
    qmp_register_command("client_migrate_info", qmp_marshal_client_migrate_info, QCO_NO_OPTIONS);
    qmp_register_command("closefd", qmp_marshal_closefd, QCO_NO_OPTIONS);
    qmp_register_command("cont", qmp_marshal_cont, QCO_NO_OPTIONS);
    qmp_register_command("cpu", qmp_marshal_cpu, QCO_NO_OPTIONS);
    qmp_register_command("cpu-add", qmp_marshal_cpu_add, QCO_NO_OPTIONS);
    qmp_register_command("device-list-properties", qmp_marshal_device_list_properties, QCO_NO_OPTIONS);
    qmp_register_command("device_del", qmp_marshal_device_del, QCO_NO_OPTIONS);
    qmp_register_command("drive-backup", qmp_marshal_drive_backup, QCO_NO_OPTIONS);
    qmp_register_command("drive-mirror", qmp_marshal_drive_mirror, QCO_NO_OPTIONS);
    qmp_register_command("dump-guest-memory", qmp_marshal_dump_guest_memory, QCO_NO_OPTIONS);
    qmp_register_command("dump-skeys", qmp_marshal_dump_skeys, QCO_NO_OPTIONS);
    qmp_register_command("eject", qmp_marshal_eject, QCO_NO_OPTIONS);
    qmp_register_command("end_record", qmp_marshal_end_record, QCO_NO_OPTIONS);
    qmp_register_command("end_replay", qmp_marshal_end_replay, QCO_NO_OPTIONS);
    qmp_register_command("expire_password", qmp_marshal_expire_password, QCO_NO_OPTIONS);
    qmp_register_command("getfd", qmp_marshal_getfd, QCO_NO_OPTIONS);
    qmp_register_command("human-monitor-command", qmp_marshal_human_monitor_command, QCO_NO_OPTIONS);
    qmp_register_command("inject-nmi", qmp_marshal_inject_nmi, QCO_NO_OPTIONS);
    qmp_register_command("input-send-event", qmp_marshal_input_send_event, QCO_NO_OPTIONS);
    qmp_register_command("list_plugins", qmp_marshal_list_plugins, QCO_NO_OPTIONS);
    qmp_register_command("load_plugin", qmp_marshal_load_plugin, QCO_NO_OPTIONS);
    qmp_register_command("memsave", qmp_marshal_memsave, QCO_NO_OPTIONS);
    qmp_register_command("migrate", qmp_marshal_migrate, QCO_NO_OPTIONS);
    qmp_register_command("migrate-incoming", qmp_marshal_migrate_incoming, QCO_NO_OPTIONS);
    qmp_register_command("migrate-set-cache-size", qmp_marshal_migrate_set_cache_size, QCO_NO_OPTIONS);
    qmp_register_command("migrate-set-capabilities", qmp_marshal_migrate_set_capabilities, QCO_NO_OPTIONS);
    qmp_register_command("migrate-set-parameters", qmp_marshal_migrate_set_parameters, QCO_NO_OPTIONS);
    qmp_register_command("migrate-start-postcopy", qmp_marshal_migrate_start_postcopy, QCO_NO_OPTIONS);
    qmp_register_command("migrate_cancel", qmp_marshal_migrate_cancel, QCO_NO_OPTIONS);
    qmp_register_command("migrate_set_downtime", qmp_marshal_migrate_set_downtime, QCO_NO_OPTIONS);
    qmp_register_command("migrate_set_speed", qmp_marshal_migrate_set_speed, QCO_NO_OPTIONS);
    qmp_register_command("nbd-server-add", qmp_marshal_nbd_server_add, QCO_NO_OPTIONS);
    qmp_register_command("nbd-server-start", qmp_marshal_nbd_server_start, QCO_NO_OPTIONS);
    qmp_register_command("nbd-server-stop", qmp_marshal_nbd_server_stop, QCO_NO_OPTIONS);
    qmp_register_command("netdev_del", qmp_marshal_netdev_del, QCO_NO_OPTIONS);
    qmp_register_command("object-add", qmp_marshal_object_add, QCO_NO_OPTIONS);
    qmp_register_command("object-del", qmp_marshal_object_del, QCO_NO_OPTIONS);
    qmp_register_command("plugin_cmd", qmp_marshal_plugin_cmd, QCO_NO_OPTIONS);
    qmp_register_command("pmemsave", qmp_marshal_pmemsave, QCO_NO_OPTIONS);
    qmp_register_command("qmp_capabilities", qmp_marshal_qmp_capabilities, QCO_NO_OPTIONS);
    qmp_register_command("qom-get", qmp_marshal_qom_get, QCO_NO_OPTIONS);
    qmp_register_command("qom-list", qmp_marshal_qom_list, QCO_NO_OPTIONS);
    qmp_register_command("qom-list-types", qmp_marshal_qom_list_types, QCO_NO_OPTIONS);
    qmp_register_command("qom-set", qmp_marshal_qom_set, QCO_NO_OPTIONS);
    qmp_register_command("query-acpi-ospm-status", qmp_marshal_query_acpi_ospm_status, QCO_NO_OPTIONS);
    qmp_register_command("query-balloon", qmp_marshal_query_balloon, QCO_NO_OPTIONS);
    qmp_register_command("query-block", qmp_marshal_query_block, QCO_NO_OPTIONS);
    qmp_register_command("query-block-jobs", qmp_marshal_query_block_jobs, QCO_NO_OPTIONS);
    qmp_register_command("query-blockstats", qmp_marshal_query_blockstats, QCO_NO_OPTIONS);
    qmp_register_command("query-chardev", qmp_marshal_query_chardev, QCO_NO_OPTIONS);
    qmp_register_command("query-chardev-backends", qmp_marshal_query_chardev_backends, QCO_NO_OPTIONS);
    qmp_register_command("query-command-line-options", qmp_marshal_query_command_line_options, QCO_NO_OPTIONS);
    qmp_register_command("query-commands", qmp_marshal_query_commands, QCO_NO_OPTIONS);
    qmp_register_command("query-cpu-definitions", qmp_marshal_query_cpu_definitions, QCO_NO_OPTIONS);
    qmp_register_command("query-cpu-model-baseline", qmp_marshal_query_cpu_model_baseline, QCO_NO_OPTIONS);
    qmp_register_command("query-cpu-model-comparison", qmp_marshal_query_cpu_model_comparison, QCO_NO_OPTIONS);
    qmp_register_command("query-cpu-model-expansion", qmp_marshal_query_cpu_model_expansion, QCO_NO_OPTIONS);
    qmp_register_command("query-cpus", qmp_marshal_query_cpus, QCO_NO_OPTIONS);
    qmp_register_command("query-dump", qmp_marshal_query_dump, QCO_NO_OPTIONS);
    qmp_register_command("query-dump-guest-memory-capability", qmp_marshal_query_dump_guest_memory_capability, QCO_NO_OPTIONS);
    qmp_register_command("query-events", qmp_marshal_query_events, QCO_NO_OPTIONS);
    qmp_register_command("query-fdsets", qmp_marshal_query_fdsets, QCO_NO_OPTIONS);
    qmp_register_command("query-gic-capabilities", qmp_marshal_query_gic_capabilities, QCO_NO_OPTIONS);
    qmp_register_command("query-hotpluggable-cpus", qmp_marshal_query_hotpluggable_cpus, QCO_NO_OPTIONS);
    qmp_register_command("query-iothreads", qmp_marshal_query_iothreads, QCO_NO_OPTIONS);
    qmp_register_command("query-kvm", qmp_marshal_query_kvm, QCO_NO_OPTIONS);
    qmp_register_command("query-machines", qmp_marshal_query_machines, QCO_NO_OPTIONS);
    qmp_register_command("query-memdev", qmp_marshal_query_memdev, QCO_NO_OPTIONS);
    qmp_register_command("query-memory-devices", qmp_marshal_query_memory_devices, QCO_NO_OPTIONS);
    qmp_register_command("query-mice", qmp_marshal_query_mice, QCO_NO_OPTIONS);
    qmp_register_command("query-migrate", qmp_marshal_query_migrate, QCO_NO_OPTIONS);
    qmp_register_command("query-migrate-cache-size", qmp_marshal_query_migrate_cache_size, QCO_NO_OPTIONS);
    qmp_register_command("query-migrate-capabilities", qmp_marshal_query_migrate_capabilities, QCO_NO_OPTIONS);
    qmp_register_command("query-migrate-parameters", qmp_marshal_query_migrate_parameters, QCO_NO_OPTIONS);
    qmp_register_command("query-name", qmp_marshal_query_name, QCO_NO_OPTIONS);
    qmp_register_command("query-named-block-nodes", qmp_marshal_query_named_block_nodes, QCO_NO_OPTIONS);
    qmp_register_command("query-pci", qmp_marshal_query_pci, QCO_NO_OPTIONS);
    qmp_register_command("query-rocker", qmp_marshal_query_rocker, QCO_NO_OPTIONS);
    qmp_register_command("query-rocker-of-dpa-flows", qmp_marshal_query_rocker_of_dpa_flows, QCO_NO_OPTIONS);
    qmp_register_command("query-rocker-of-dpa-groups", qmp_marshal_query_rocker_of_dpa_groups, QCO_NO_OPTIONS);
    qmp_register_command("query-rocker-ports", qmp_marshal_query_rocker_ports, QCO_NO_OPTIONS);
    qmp_register_command("query-rx-filter", qmp_marshal_query_rx_filter, QCO_NO_OPTIONS);
    qmp_register_command("query-spice", qmp_marshal_query_spice, QCO_NO_OPTIONS);
    qmp_register_command("query-status", qmp_marshal_query_status, QCO_NO_OPTIONS);
    qmp_register_command("query-target", qmp_marshal_query_target, QCO_NO_OPTIONS);
    qmp_register_command("query-tpm", qmp_marshal_query_tpm, QCO_NO_OPTIONS);
    qmp_register_command("query-tpm-models", qmp_marshal_query_tpm_models, QCO_NO_OPTIONS);
    qmp_register_command("query-tpm-types", qmp_marshal_query_tpm_types, QCO_NO_OPTIONS);
    qmp_register_command("query-uuid", qmp_marshal_query_uuid, QCO_NO_OPTIONS);
    qmp_register_command("query-version", qmp_marshal_query_version, QCO_NO_OPTIONS);
    qmp_register_command("query-vnc", qmp_marshal_query_vnc, QCO_NO_OPTIONS);
    qmp_register_command("query-vnc-servers", qmp_marshal_query_vnc_servers, QCO_NO_OPTIONS);
    qmp_register_command("quit", qmp_marshal_quit, QCO_NO_OPTIONS);
    qmp_register_command("remove-fd", qmp_marshal_remove_fd, QCO_NO_OPTIONS);
    qmp_register_command("ringbuf-read", qmp_marshal_ringbuf_read, QCO_NO_OPTIONS);
    qmp_register_command("ringbuf-write", qmp_marshal_ringbuf_write, QCO_NO_OPTIONS);
    qmp_register_command("rtc-reset-reinjection", qmp_marshal_rtc_reset_reinjection, QCO_NO_OPTIONS);
    qmp_register_command("screendump", qmp_marshal_screendump, QCO_NO_OPTIONS);
    qmp_register_command("send-key", qmp_marshal_send_key, QCO_NO_OPTIONS);
    qmp_register_command("set_link", qmp_marshal_set_link, QCO_NO_OPTIONS);
    qmp_register_command("set_password", qmp_marshal_set_password, QCO_NO_OPTIONS);
    qmp_register_command("stop", qmp_marshal_stop, QCO_NO_OPTIONS);
    qmp_register_command("system_powerdown", qmp_marshal_system_powerdown, QCO_NO_OPTIONS);
    qmp_register_command("system_reset", qmp_marshal_system_reset, QCO_NO_OPTIONS);
    qmp_register_command("system_wakeup", qmp_marshal_system_wakeup, QCO_NO_OPTIONS);
    qmp_register_command("trace-event-get-state", qmp_marshal_trace_event_get_state, QCO_NO_OPTIONS);
    qmp_register_command("trace-event-set-state", qmp_marshal_trace_event_set_state, QCO_NO_OPTIONS);
    qmp_register_command("transaction", qmp_marshal_transaction, QCO_NO_OPTIONS);
    qmp_register_command("unload_plugin", qmp_marshal_unload_plugin, QCO_NO_OPTIONS);
    qmp_register_command("x-blockdev-change", qmp_marshal_x_blockdev_change, QCO_NO_OPTIONS);
    qmp_register_command("x-blockdev-del", qmp_marshal_x_blockdev_del, QCO_NO_OPTIONS);
    qmp_register_command("x-blockdev-insert-medium", qmp_marshal_x_blockdev_insert_medium, QCO_NO_OPTIONS);
    qmp_register_command("x-blockdev-remove-medium", qmp_marshal_x_blockdev_remove_medium, QCO_NO_OPTIONS);
    qmp_register_command("x-colo-lost-heartbeat", qmp_marshal_x_colo_lost_heartbeat, QCO_NO_OPTIONS);
    qmp_register_command("xen-load-devices-state", qmp_marshal_xen_load_devices_state, QCO_NO_OPTIONS);
    qmp_register_command("xen-save-devices-state", qmp_marshal_xen_save_devices_state, QCO_NO_OPTIONS);
    qmp_register_command("xen-set-global-dirty-log", qmp_marshal_xen_set_global_dirty_log, QCO_NO_OPTIONS);
}
