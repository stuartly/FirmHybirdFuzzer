...
const char *const GuestPanicInformationKind_lookup[] = {
    [GUEST_PANIC_INFORMATION_KIND_HYPER_V] = "hyper-v",
    [GUEST_PANIC_INFORMATION_KIND__MAX] = NULL,
};
...
void qapi_free_PandaPluginInfo(PandaPluginInfo *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_PandaPluginInfo(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_PandaPluginInfoList(PandaPluginInfoList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_PandaPluginInfoList(v, NULL, &obj, NULL);
    visit_free(v);
}
