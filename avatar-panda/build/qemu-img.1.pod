...
=item B<bench [-c> I<count>B<] [-d> I<depth>B<] [-f> I<fmt>B<] [--flush-interval=>I<flush_interval>B<] [-n] [--no-drain] [-o> I<offset>B<] [--pattern=>I<pattern>B<] [-q] [-s> I<buffer_size>B<] [-S> I<step_size>B<] [-t> I<cache>B<] [-w]> I<filename>


=item B<check [--object> I<objectdef>B<] [--image-opts] [-q] [-f> I<fmt>B<] [--output=>I<ofmt>B<] [-r [leaks | all]] [-T> I<src_cache>B<]> I<filename>


=item B<create [--object> I<objectdef>B<] [--image-opts] [-q] [-f> I<fmt>B<] [-o> I<options>B<]> I<filename> B<[>I<size>B<]>


=item B<commit [--object> I<objectdef>B<] [--image-opts] [-q] [-f> I<fmt>B<] [-t> I<cache>B<] [-b> I<base>B<] [-d] [-p]> I<filename>


=item B<compare [--object> I<objectdef>B<] [--image-opts] [-f> I<fmt>B<] [-F> I<fmt>B<] [-T> I<src_cache>B<] [-p] [-q] [-s]> I<filename1>B< >I<filename2>


=item B<convert [--object> I<objectdef>B<] [--image-opts] [-c] [-p] [-q] [-n] [-f> I<fmt>B<] [-t> I<cache>B<] [-T> I<src_cache>B<] [-O> I<output_fmt>B<] [-o> I<options>B<] [-s> I<snapshot_id_or_name>B<] [-l> I<snapshot_param>B<] [-S> I<sparse_size>B<]> I<filename> B<[>I<filename2> B<[...]]> I<output_filename>


=item B<dd [--image-opts] [-f> I<fmt>B<] [-O> I<output_fmt>B<] [bs=>I<block_size>B<] [count=>I<blocks>B<] [skip=>I<blocks>B<] if=>I<input> B<of=>I<output>


=item B<info [--object> I<objectdef>B<] [--image-opts] [-f> I<fmt>B<] [--output=>I<ofmt>B<] [--backing-chain]> I<filename>


=item B<map [--object> I<objectdef>B<] [--image-opts] [-f> I<fmt>B<] [--output=>I<ofmt>B<]> I<filename>


=item B<snapshot [--object> I<objectdef>B<] [--image-opts] [-q] [-l | -a> I<snapshot> B<| -c> I<snapshot> B<| -d> I<snapshot>B<]> I<filename>


=item B<rebase [--object> I<objectdef>B<] [--image-opts] [-q] [-f> I<fmt>B<] [-t> I<cache>B<] [-T> I<src_cache>B<] [-p] [-u] -b> I<backing_file> B<[-F> I<backing_fmt>B<]> I<filename>


=item B<resize [--object> I<objectdef>B<] [--image-opts] [-q]> I<filename> B<[+ | -]>I<size>
...
Indicates that the I<filename> parameter is to be interpreted as a
full option string, not a plain filename. This parameter is mutually
exclusive with the I<-f> and I<-F> parameters.
...
=item B<dd [-f> I<fmt>B<] [-O> I<output_fmt>B<] [bs=>I<block_size>B<] [count=>I<blocks>B<] [skip=>I<blocks>B<] if=>I<input> B<of=>I<output>
