...
void visit_type_GuestPanicInformation_members(Visitor *v, GuestPanicInformation *obj, Error **errp)
{
    ...
    visit_type_GuestPanicInformationKind(v, "type", &obj->type, &err);
    if (err) {
        goto out;
    }
    switch (obj->type) {
    case GUEST_PANIC_INFORMATION_KIND_HYPER_V:
        visit_type_q_obj_GuestPanicInformationHyperV_wrapper_members(v, &obj->u.hyper_v, &err);
        break;
    default:
        abort();
    }
...
void visit_type_GuestPanicInformationKind(Visitor *v, const char *name, GuestPanicInformationKind *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, GuestPanicInformationKind_lookup, errp);
    *obj = value;
}
...
void visit_type_PandaPluginInfo_members(Visitor *v, PandaPluginInfo *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_PandaPluginInfo(Visitor *v, const char *name, PandaPluginInfo **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(PandaPluginInfo), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_PandaPluginInfo_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_PandaPluginInfoList(Visitor *v, const char *name, PandaPluginInfoList **obj, Error **errp)
{
    Error *err = NULL;
    PandaPluginInfoList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (PandaPluginInfoList *)visit_next_list(v, (GenericList *)tail, size)) {
        visit_type_PandaPluginInfo(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
    ...
    visit_end_list(v, (void **)obj);
    if (err && visit_is_input(v)) {
        qapi_free_PandaPluginInfoList(*obj);
        *obj = NULL;
    }
out:
    error_propagate(errp, err);
...
void visit_type_q_obj_GuestPanicInformationHyperV_wrapper_members(Visitor *v, q_obj_GuestPanicInformationHyperV_wrapper *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_GuestPanicInformationHyperV(v, "data", &obj->data, &err);
    if (err) {
        goto out;
    }
...
void visit_type_q_obj_begin_record_arg_members(Visitor *v, q_obj_begin_record_arg *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_str(v, "file_name", &obj->file_name, &err);
    if (err) {
        goto out;
    }
...
void visit_type_q_obj_begin_record_from_arg_members(Visitor *v, q_obj_begin_record_from_arg *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_q_obj_begin_replay_arg_members(Visitor *v, q_obj_begin_replay_arg *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_q_obj_load_plugin_arg_members(Visitor *v, q_obj_load_plugin_arg *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "file_name", &obj->has_file_name)) {
        visit_type_str(v, "file_name", &obj->file_name, &err);
        if (err) {
            goto out;
        }
    }
    visit_type_str(v, "plugin_name", &obj->plugin_name, &err);
    if (err) {
        goto out;
    }
    if (visit_optional(v, "plugin_args", &obj->has_plugin_args)) {
        visit_type_str(v, "plugin_args", &obj->plugin_args, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_q_obj_plugin_cmd_arg_members(Visitor *v, q_obj_plugin_cmd_arg *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_str(v, "cmd", &obj->cmd, &err);
    if (err) {
        goto out;
    }
...
void visit_type_q_obj_unload_plugin_arg_members(Visitor *v, q_obj_unload_plugin_arg *obj, Error **errp)
{
    Error *err = NULL;
